...
cl /nologo /MT /Z7 /Gm- /GR- /EHs- /EHa- /Od /Oi /FC /W4 /WX ..\code\client.cpp /link /OPT:REF /SUBSYSTEM:WINDOWS,5.2 /LIBPATH:%VULKAN_SDK_PATH%\Source\lib User32.lib vulkan-1.lib Ws2_32.lib Winmm.lib
